...
This requires `runBulkInviteLoop` to track and return the first error message.
...
- [ ] Existing bulk invite functionality (progress updates, cancel button, CSV output, upload) remains unchanged
